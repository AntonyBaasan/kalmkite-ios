            ...
            VStack(spacing: 0) {
                ...
                if timeCompleted || allItemsFound {
                    Button {
                        ...
                        Text(allItemsFound ? "All Found! Complete Walk" : "Time's Up - Complete Walk")
                            .font(.headline)
        ...
        .fullScreenCover(isPresented: $isComplete) {
            ExerciseResultView(
                result: ExerciseResult(
                    ...
                    motivation: allItemsFound ? "You found everything and stayed present!" : "You stayed mindful during your walk.",
...
#Preview {
    WalkSessionView(exerciseId: 5, selectedItems: [
